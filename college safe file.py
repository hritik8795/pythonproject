...
def collegePage():
    ...
    b2 = Button(f1, text="M.TECH", font=("", 25))
    b2.place(x=750, y=240)
    b3 = Button(f1, text="BBA", font=("", 25))
    b3.place(x=600, y=500)
    b4 = Button(f1, text="BCA", font=("", 25))
    b4.place(x=150, y=350)
    b5 = Button(f1, text="MBA", font=("", 25))
    b5.place(x=300, y=350)
    b6 = Button(f1, text="MCA", font=("", 25))
    b6.place(x=450, y=350)
    b7 = Button(f1, text="B.SC", font=("", 25))
    b7.place(x=600, y=350)
    b8 = Button(f1, text="B.SC(Ag)", font=("", 25))
    b8.place(x=750, y=350)
    b9 = Button(f1, text="B.Pharma", font=("", 25))
    b9.place(x=400, y=500)
    b10 = Button(f1, text="D.pharma", font=("", 25) )
